...
describe("Match Columns automatic matching", () => {
    test("AutoMatch column and click next", async () => {
        ...
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockRsiValues, fields }}>
    ...
    test("AutoMatching disabled does not match any columns", async () => {
        ...
        const result = [{}, {}, {}];
        const onContinue = jest.fn();
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockRsiValues, fields, autoMapHeaders: false }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
          <MatchColumnsStep headerValues={header} data={data} onContinue={onContinue}/>
        </ModalWrapper>
      </Providers>);
    ...
    test("AutoMatching exact values", async () => {
        ...
        const result = [{ name: data[0][0] }, { name: data[1][0] }, { name: data[2][0] }];
        const onContinue = jest.fn();
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockRsiValues, fields, autoMapDistance: 1 }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
          <MatchColumnsStep headerValues={header} data={data} onContinue={onContinue}/>
        </ModalWrapper>
      </Providers>);
    ...
    test("AutoMatches only one value", async () => {
        ...
        const onContinue = jest.fn();
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockRsiValues, fields: alternativeFields }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
          <MatchColumnsStep headerValues={header} data={data} onContinue={onContinue}/>
        </ModalWrapper>
      </Providers>);
...
describe("Match Columns general tests", () => {
    ...
    test("Selecting select field adds more selects", async () => {
        ...
        const onContinue = jest.fn();
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockRsiValues, fields: enumFields }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
          <MatchColumnsStep headerValues={header} data={data} onContinue={onContinue}/>
          <div id={SELECT_DROPDOWN_ID}/>
        </ModalWrapper>
    ...
    test("Required unselected fields show warning alert on submit", async () => {
        ...
        const onContinue = jest.fn();
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockRsiValues, fields: requiredFields }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
          <MatchColumnsStep headerValues={header} data={data} onContinue={onContinue}/>
        </ModalWrapper>
      </Providers>);
    ...
    test("matchColumnsStepHook should be called after columns are matched", async () => {
        ...
        render(<ReactSpreadsheetImport {...mockValues} matchColumnsStepHook={matchColumnsStepHook} initialStepState={{
