...
const getFilterSwitch = () => screen.getByRole("checkbox", {
...
describe("Validation step tests", () => {
    test("Submit data", async () => {
        ...
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockValues, onSubmit: onSubmit }}>
    ...
    test("Filters rows with required errors", async () => {
        ...
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockValues, fields }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
    ...
    test("Filters rows with errors, fixes row, removes filter", async () => {
        ...
        const onSubmit = jest.fn();
        render(<Providers theme={defaultTheme} rsiValues={{ ...mockValues, fields, onSubmit }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
          <ValidationStep initialData={initialData} file={file}/>
        </ModalWrapper>
      </Providers>);
    ...
    test("All inputs change values", async () => {
        ...
        render(<Providers theme={defaultTheme} rsiValues={{
                ...mockValues,
                fields,
            }}>
        <ModalWrapper isOpen={true} onClose={() => { }}>
